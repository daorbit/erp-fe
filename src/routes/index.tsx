...
const AdminModuleSiteView = lazy(() => import('../pages/admin-module/site/View'));
...
export default function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/shift-sessions/report" element={<R roles={ALL_COMPANY}><ShiftSessionsReport /></R>} />
      ...
      <Route path="/admin-module/master/site/view/:id" element={<R roles={ADMINS}><AdminModuleSiteView /></R>} />
