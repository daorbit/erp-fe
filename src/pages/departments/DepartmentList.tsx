...
const DepartmentList: React.FC = () => {
  ...
  const stats = [
    { title: 'Total Departments', value: totalDepts, icon: <Building2 size={20} />, color: '#3b82f6', bg: 'bg-blue-50 dark:bg-blue-950' },
    { title: 'Active', value: activeDepts, icon: <CheckCircle2 size={20} />, color: '#10b981', bg: 'bg-green-50 dark:bg-green-950' },
    { title: 'Total Employees', value: totalEmpCount, icon: <Users size={20} />, color: '#8b5cf6', bg: 'bg-purple-50 dark:bg-purple-950' },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button type="primary" icon={<Plus size={16} />} onClick={() => { setEditRecord(null); setModalOpen(true); }}>Add Department</Button>
      </div>
      ...
      <Card bordered={false}>
        <div className="mb-4">
          <Input prefix={<Search size={16} />} placeholder="Search departments..." value={search} onChange={e => setSearch(e.target.value)} className="max-w-xs" allowClear />
        </div>
