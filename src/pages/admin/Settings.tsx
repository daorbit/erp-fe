            ...
            {(
              ...
              <Radio.Button
                ...
                style={{
                  ...
                  border:
                    mode === item.value
                      ? `2px solid ${palettes[colorTheme].primary}`
                      : `2px solid ${isDark ? "#2d3140" : "#e2e8f0"}`,
                  flex: 1,
                  textAlign: "left",
    ...
    },
    {
      ...
      children: (
        <div style={{ maxWidth: 600 }}>
          {[
            {
              label: "Email notifications for new onboarding",
              desc: "Receive email when a new employee starts KYC",
              default: true,
            },
            {
              label: "KYC completion alerts",
              desc: "Get notified when KYC is fully completed",
              default: true,
            },
            {
              label: "Weekly summary report",
              desc: "Receive weekly HR summary via email",
              default: false,
            },
            {
              label: "Document expiry reminders",
              desc: "Alert when employee documents are about to expire",
              default: true,
            },
          ].map((item, i) => (
            <div
